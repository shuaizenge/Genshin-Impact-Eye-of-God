               ...
               SysMpuConfig *mpu_cfg)
{
    ...
    mpu.initialize();
    Serial.print(F("Initialization MPU6050 ok\n"));
...
ImuAction *IMU::update(int interval)
{
    ...
    // Serial.print("a/g:\t");
    // Serial.print(action_info.v_ax); Serial.print("\t");
    // Serial.print(action_info.v_ay); Serial.print("\t");
    // Serial.print(action_info.v_az); Serial.print("\t");
    // Serial.print(action_info.v_gx); Serial.print("\t");
    // Serial.print(action_info.v_gy); Serial.print("\t");
    // Serial.println(action_info.v_gz);
    // 原先判断的只是加速度，现在要加上陀螺仪
